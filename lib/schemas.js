...
module.exports = function() {
  ...
  // var CalculationRowSchema = new Schema({
  //   _calculationRowCollection : { type: Schema.Types.ObjectId, ref: 'CalculationRowCollection' },
  //   _calculationRowType : { type: Schema.Types.ObjectId, ref: 'CalculationRowType' },
  //   value: Number,
  // });

  // mongoose.model('CalculationRowCollection', CalculationRowCollectionSchema);
};